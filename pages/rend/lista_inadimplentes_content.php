...
<!-- Google Fonts - Fontes Premium -->
 <link rel="stylesheet" href="/css/lista_inadimplentes_v5.css">
                        ...
                        <div class="info-card-modern">
                            ...
                            <div class="card-body-modern">
                                <div class="contact-item" id="contatoTelefoneInadim">
                                    ...
                                    <button class="contact-action" onclick="ListaInadimplentes.ligarTelefone()"
                                        title="Ligar">
                                ...
                                <div class="contact-item" id="contatoEmailInadim">
                                    ...
                                    <button class="contact-action" onclick="ListaInadimplentes.enviarEmail()"
                                        title="Enviar e-mail">
                ...
                <div class="renegociacao-section">
                    ...
                    <div class="renegociacao-body">
                        ...
                        <div class="renegociacao-info">
                            ...
                            <p>O valor renegociado será incluído na próxima fatura do associado. Esta ação ficará
                                registrada no histórico financeiro.</p>
                        </div>
                    </div>
                </div>
...
<style>
    ...
    /* ===== TELA DE QUITAÇÃO COMPLETA - NOVO ===== */
    .quitacao-completa {
        text-align: center;
        padding: 4rem 2rem;
    ...
    @keyframes pulse-success {
        ...
        50% {
            box-shadow: 0 10px 60px rgba(22, 163, 74, 0.5);
            transform: scale(1.05);
        }
    }

    .quitacao-completa h3 {
        font-size: 1.75rem;
        font-weight: 800;
        color: #166534;
        margin: 0 0 0.5rem 0;
    ...
    .quitacao-badge {
        ...
        animation: badge-entrance 0.5s ease;
    }
    ...
    /* ===== ANIMAÇÃO DE REMOÇÃO DE LINHA - NOVO ===== */
    .pendencia-row.removing {
        opacity: 0;
    ...
    /* ===== TOAST MEGA SUCCESS - NOVO ===== */
    .toast-custom.mega-success {
        background: linear-gradient(135deg, #16a34a 0%, #15803d 100%);
        border: none;
        color: white;
        min-width: 400px;
    ...
    .toast-custom.mega-success .toast-icon {
        background: white;
        color: #16a34a;
    }

    .toast-custom.mega-success .toast-message {
        color: white;
        font-weight: 600;
    }

    .toast-custom.mega-success .toast-close {
        color: white;
    }

    .toast-custom.mega-success .toast-close:hover {
        color: #dcfce7;
    }
    ...
    @media (max-width: 768px) {
        ...
        .badge-quitado i {
            font-size: 0.875rem;
            animation: check-bounce 0.6s ease 0.3s;
        }
        ...
        .valor-original.quitado {
            text-decoration: line-through;
            opacity: 0.5;
        }

        .input-valor-acerto.quitado input {
            background: #f3f4f6;
            border-color: #d1d5db;
            cursor: not-allowed;
        }
