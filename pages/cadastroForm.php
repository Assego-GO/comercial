<?php
/**
 * Formulário de Cadastro de Associados - VERSÃO COM PRÉ-CADASTRO
...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Estilos específicos para a ficha assinada */
        .btn-warning {
...
<body>
    ...
    <div class="content-area">
        ...
        <!-- Aviso sobre Pré-Cadastro -->
        <?php if (!$isEdit): ?>
            <div class="alert-custom alert-warning">
                <i class="fas fa-info-circle"></i>
                <div>
                    <strong>Sistema de Pré-Cadastro</strong>
                    <p style="margin: 0.25rem 0 0 0; font-size: 0.875rem;">
                        Todos os novos associados são criados como pré-cadastro e precisam passar pela aprovação da
                        presidência para se tornarem associados definitivos.
                    </p>
                </div>
            </div>
        <?php endif; ?>
                                    ...
                                    <div
                                        ...
                                        <div class="checkbox-item">
                                            ...
                                            <label for="enviar_presidencia" style="color: #856404; font-weight: 600;">
                                                ...
                                                presidência após o cadastro
                                            </label>
                                        </div>
                                        <p
                                            style="font-size: 0.75rem; color: #856404; margin-top: 0.5rem; margin-left: 1.5rem;">
                                            Se desmarcado, o pré-cadastro ficará aguardando até que você envie manualmente
                                            para aprovação.
                                        </p>
                                    </div>
                                </div>
    ...
    <script>
        // JavaScript Completo com FALLBACKS e PRÉ-CADASTRO
        ...
        // Validação do step atual - ATUALIZADA PARA PRÉ-CADASTRO
    ...
    `;
        ...
        // Função para salvar associado - ATUALIZADA PARA PRÉ-CADASTRO
        function salvarAssociado() {
            console.log('=== SALVANDO ASSOCIADO (PRÉ-CADASTRO COM FLUXO) ===');
            ...
            console.log('Método:', isEdit ? 'ATUALIZAR' : 'CRIAR PRÉ-CADASTRO');
            ...
            fetch(url, {
                ...
                .then(responseText => {
                    ...
                    if (data.status === 'success') {
                        ...
                        let mensagem = isEdit ? 'Associado atualizado com sucesso!' : 'Pré-cadastro realizado com sucesso!';
        ...
        <div class="overview-card" style="background: var(--gray-100); padding: 2rem; border-radius: 16px; margin-bottom: 1.5rem;">
            <div class="overview-card-header" style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1.5rem; padding-bottom: 1rem; border-bottom: 2px solid var(--gray-200);">
                ...
                <h3 class="overview-card-title" style="font-size: 1.25rem; font-weight: 700; color: var(--dark); margin: 0;">Resumo do Cadastro</h3>
            </div>
            ...
            // Se não for edição, adiciona aviso sobre pré-cadastro
            if (!isEdit) {
                html += `
        <div class="alert-custom alert-warning" style="background: linear-gradient(135deg, #fff3cd 0%, #ffeaa7 100%); color: #856404; border: 1px solid #f0ad4e;">
            ...
            <div>
                ...
                <p style="margin: 0.25rem 0 0 0; font-size: 0.875rem;">
                    Este cadastro será criado como PRÉ-CADASTRO e precisará ser aprovado pela presidência para se tornar definitivo.
                    ${formData.get('enviar_presidencia') === '1' ? 'O cadastro será enviado automaticamente para aprovação.' : 'Você precisará enviar manualmente para aprovação após o cadastro.'}
                </p>
            </div>
        </div>`;
            }
